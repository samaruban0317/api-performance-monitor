...
![API Performance Monitor dashboard](docs/screenshots/dashboard.png)

---

## Screenshots

| Live dashboard | Endpoint latency detail |
|:---:|:---:|
| ![Dashboard](docs/screenshots/dashboard.png) | ![Endpoint detail](docs/screenshots/endpoint-detail.png) |

The dashboard surfaces fleet-wide KPIs, ranked performance insights (here flagging a
flaky endpoint and a slow one), and a per-endpoint breakdown. Clicking any row reveals
its recent latency trace. It is fully responsive:

<p align="center">
  <img src="docs/screenshots/dashboard-mobile.png" alt="Mobile dashboard" width="320" />
</p>

> Screenshots use synthetic demo data generated by `python -m scripts.seed`, and are
> captured with `python -m scripts.screenshots` (requires `pip install -r requirements-dev.txt`).
